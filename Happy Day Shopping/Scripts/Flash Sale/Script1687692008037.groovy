...
Mobile.setText(findTestObject('Object Repository/android.widget.EditText - 1'), '4', 0)

Mobile.tap(findTestObject('Object Repository/android.view.ViewGroup (2)'), 0)

Mobile.tap(findTestObject('android.widget.ImageView - your bag'), 0)

Mobile.tap(findTestObject('Object Repository/android.view.ViewGroup (3)'), 0)

Mobile.verifyElementText(findTestObject('Object Repository/android.widget.TextView - Shopping cart'), 'Shopping cart')
